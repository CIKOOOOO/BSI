...
public interface ApiInterface {
    ...
    @Headers({"Content-Type:application/json;", "client-id: OV4B2FXHY1Y7W0WMSUUB", "hashcode: "})
    @POST("mobile/login")
    Call<OutputResponse> loginWith(@Body Map<String, Object> data);

    @Headers({"Accept: application/json", "client-id: OV4B2FXHY1Y7W0WMSUUB", "hashcode: "})
    ...
    @Headers({"client-id: OV4B2FXHY1Y7W0WMSUUB", "hashcode: "})
